...
#blynk = BlynkLib.Blynk("Gurl2O0DoNv46y8iKKJmNTx1w15NLJ7l", server='blynk.cloud')
...
def main_process():
    ...
    while not stop_event.is_set():
        print("Starting AutomatizaciaOhrevuTUV.py...")
        ...
        proc = subprocess.Popen(["C:/Users/adria/AppData/Local/Programs/Python/Python312/python", "AutomatizaciaOhrevuTUV.py"],
