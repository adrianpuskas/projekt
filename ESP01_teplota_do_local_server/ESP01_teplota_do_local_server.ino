...
void DHTsenzor() {
  ...
  // Blynk
  Blynk.virtualWrite(V30, senzorTeploty);
  Blynk.virtualWrite(V40, senzorVlhkostiVzuchu);

  // Lokálny server
  sendToLocalServer("indoor_temp", senzorTeploty);
  sendToLocalServer("indoor_humidity", (float)senzorVlhkostiVzuchu);
}
