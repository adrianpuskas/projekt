...
<head>
  ...
  <style>
    ...
    .inverter-info { font-size: 0.9rem; color: #ccc; }
    [data-bs-theme="light"] .inverter-info { color: #666; }
    .inverter-info i { color: #aaa; font-size: 0.9em; }
  </style>
</head>
<body>
        ...
        <div class="card-body py-4">
          <div class="row">
            ...
            <div class="col-9 d-flex flex-column justify-content-center">
              ...
              <!-- Režim a teplota meniča – zarovnané vľavo -->
              <div class="inverter-info">
                <div class="row g-2">
                  <div class="col-6 d-flex align-items-center">
                    <i class="fas fa-cog me-2"></i> Režim: <strong id="home-mode-value" class="ms-1">-</strong>
                  </div>
                  <div class="col-6 d-flex align-items-center">
                    <i class="fas fa-thermometer-half me-2"></i> Menič: <strong id="home-temp-value" class="ms-1">-</strong>°C
                  </div>
                </div>
              </div>
            </div>
