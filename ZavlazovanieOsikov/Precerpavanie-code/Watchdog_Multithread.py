...
try:
    while True:
        ...
        proc = subprocess.Popen(["/usr/bin/python3.9", "Main_Multithread.py"], stdin=subprocess.PIPE, env=env)  # spustenie Main.py v novom procese a handle procesu je uložený v premennej proc.
