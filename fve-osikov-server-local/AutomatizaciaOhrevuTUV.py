                ...
                if read_inverter_mode == "Battery":
                    ...
                    if stav_ohrevu == 0:
                        ...
                        if priorita_FVE == 0 and kapacita_bateria < BAT_CAP_ON: ## 0 - bateria / 1 - TUV
                            ...
                            #if vykon_zataz+150 <       4000      and ((       -120W      <       0       >      +150W    ) or (    0         >      +150W     or (kapacita_bateria >=      30%   and napatie_panely > 210,65    )) and vykon_ohrevu <  100%    ):
                                
                            if vykon_zataz+150 < MAX_ZATAZ_VYKON and ((BAT_MAX_DISCHARGE < vykon_bateria > BAT_SAFE_RANGE) or (vykon_bateria > BAT_SAFE_RANGE or (kapacita_bateria >= BAT_CAP_ON and napatie_panely > string_MPV and BAT_MAX_DISCHARGE < vykon_bateria > 50)) and vykon_ohrevu < MAX_VYKON):
                                ...
                                if new_power == 25 and vykon_bateria < BAT_MAX_DISCHARGE2:
                                    new_power = 5
